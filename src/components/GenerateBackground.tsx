...
export default function GenerateBackground({}) {
   let str1 = `bg-blue-700 text-white absolute rotate-[10deg] top-[-90px] left-[30px] select-none text-5xl filter bg-clip-text mix-blend-overlay blur-sm animation-delay-100 z-30 animate-word`;
   ...
   let str4 = `bg-blue-700 text-white absolute rotate-[40deg] top-[90px] left-[15px] select-none text-5xl filter bg-clip-text mix-blend-overlay blur-sm animation-delay-400 z-30 animate-word3`;
   ...
   let str6 = `bg-blue-700 text-white absolute rotate-[-20deg] top-[0px] left-[-30px] select-none text-5xl filter bg-clip-text mix-blend-overlay blur-sm animation-delay-300 z-30 animate-word5`;
